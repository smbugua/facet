...
<html lang="en">
	<head>
		...
		<title>FaceTwitGram Login</title>
			...
			<header class="sp-header">
				<div class="sp-logo-wrap pull-left">
					<a href="index.php">
						...
						<span class="brand-text">FaceTwitGram</span>
					</a>
				</div>
				<div class="form-group mb-0 pull-right">
					<span class="inline-block pr-10 txt-light-grey">Don't have an account?</span>
					<a class="inline-block btn btn-warning  btn-rounded " href="signup.php">Sign Up</a>
				</div>
							...
							<div class="auth-form  ml-auto mr-auto no-float card-view pt-30 pb-30">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Sign in to FaceTwitGram</h3>
